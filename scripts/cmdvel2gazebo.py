...
class CmdVel2Gazebo:
    ...
    def __init__(self):
        ...
        self.pub_rearL = rospy.Publisher('/airport_robot/rear_left_velocity_controller/command', Float64, queue_size=1)
        self.pub_rearR = rospy.Publisher('/airport_robot/rear_right_velocity_controller/command', Float64, queue_size=1)
